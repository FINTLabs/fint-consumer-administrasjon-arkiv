...
;
    ...
    public static final String CACHE_INITIALDELAY_KORRESPONDANSEPARTTYPE = "${fint.consumer.cache.initialDelay.korrespondanseparttype:1560000}";
    ...
    public static final String CACHE_INITIALDELAY_MERKNADSTYPE = "${fint.consumer.cache.initialDelay.merknadstype:1620000}";
    public static final String CACHE_FIXEDRATE_MERKNADSTYPE = "${fint.consumer.cache.fixedRate.merknadstype:900000}";
    
    public static final String CACHE_INITIALDELAY_PART = "${fint.consumer.cache.initialDelay.part:1680000}";
    public static final String CACHE_FIXEDRATE_PART = "${fint.consumer.cache.fixedRate.part:900000}";
    
    public static final String CACHE_INITIALDELAY_PARTROLLE = "${fint.consumer.cache.initialDelay.partrolle:1740000}";
    ...
    public static final String CACHE_INITIALDELAY_SAK = "${fint.consumer.cache.initialDelay.sak:1860000}";
    public static final String CACHE_FIXEDRATE_SAK = "${fint.consumer.cache.fixedRate.sak:900000}";
    
    public static final String CACHE_INITIALDELAY_SAKSSTATUS = "${fint.consumer.cache.initialDelay.saksstatus:1920000}";
    public static final String CACHE_FIXEDRATE_SAKSSTATUS = "${fint.consumer.cache.fixedRate.saksstatus:900000}";
    
    public static final String CACHE_INITIALDELAY_SKJERMINGSHJEMMEL = "${fint.consumer.cache.initialDelay.skjermingshjemmel:1980000}";
    public static final String CACHE_FIXEDRATE_SKJERMINGSHJEMMEL = "${fint.consumer.cache.fixedRate.skjermingshjemmel:900000}";
    
    public static final String CACHE_INITIALDELAY_TILGANG = "${fint.consumer.cache.initialDelay.tilgang:2040000}";
    ...
    public static final String CACHE_INITIALDELAY_TILKNYTTETREGISTRERINGSOM = "${fint.consumer.cache.initialDelay.tilknyttetregistreringsom:2160000}";
    ...
    public static final String CACHE_INITIALDELAY_VARIANTFORMAT = "${fint.consumer.cache.initialDelay.variantformat:2220000}";
