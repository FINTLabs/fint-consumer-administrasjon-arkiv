...
public class KlasseCacheService extends CacheService<KlasseResource> {
    ...
    public KlasseCacheService() {
        super(MODEL, ArkivActions.GET_ALL_KLASSE, ArkivActions.UPDATE_KLASSE);
    ...
    public void populateCache(String orgId) {
        ...
        Event event = new Event(orgId, Constants.COMPONENT, ArkivActions.GET_ALL_KLASSE, Constants.CACHE_SERVICE);
        consumerEventUtil.send(event);
    }


    public Optional<KlasseResource> getKlasseByKlasseId(String orgId, String klasseId) {
        return getOne(orgId, klasseId.hashCode(),
            (resource) -> Optional
                .ofNullable(resource)
                .map(KlasseResource::getKlasseId)
    ...
    public void onAction(Event event) {
        ...
        if (ArkivActions.valueOf(event.getAction()) == ArkivActions.UPDATE_KLASSE) {
